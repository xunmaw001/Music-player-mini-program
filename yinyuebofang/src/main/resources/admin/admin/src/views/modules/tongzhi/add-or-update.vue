    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="通知编号" prop="tongzhiUuidNumber">
                       <el-input v-model="ruleForm.tongzhiUuidNumber"
                                 placeholder="通知编号" clearable  :readonly="ro.tongzhiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="通知编号" prop="tongzhiUuidNumber">
                           <el-input v-model="ruleForm.tongzhiUuidNumber"
                                     placeholder="通知编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="通知标题" prop="tongzhiName">
                       <el-input v-model="ruleForm.tongzhiName"
                                 placeholder="通知标题" clearable  :readonly="ro.tongzhiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="通知标题" prop="tongzhiName">
                           <el-input v-model="ruleForm.tongzhiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.tongzhiContent"  label="通知内容" prop="tongzhiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tongzhiContent" label="通知内容" prop="tongzhiContent">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    tongzhiUuidNumber: new Date().getTime(),
                    tongzhiName: '',
                    tongzhiTypes: '',
                    tongzhiContent: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   tongzhiUuidNumber: [
                              { required: true, message: '通知编号不能为空', trigger: 'blur' },
                          ],
                   tongzhiName: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.tongzhiContent = _this.ruleForm.tongzhiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.tongzhiContent = this.ruleForm.tongzhiContent.replaceAll(this.$base.url,"");
                        this.$http({
