                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yinyuebofang/upload/gonggaoMuBan.xls"
                        >批量导入公告信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'gonggao',//当前表表名,
                        sumColum : 'gonggao_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'gonggao_name',//分组字符串字段
                        // types : 'gonggao_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            getDataList() {
                ...
                if (this.searchForm.gonggaoTypes!= '' && this.searchForm.gonggaoTypes!= undefined) {
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=gonggao_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.gonggaoTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
