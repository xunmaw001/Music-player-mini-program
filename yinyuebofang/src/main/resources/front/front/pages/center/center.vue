<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"var(--publicSubColor)","height":"200rpx"}'>
            ...
            <view v-if="tableName=='yonghu'" class="userinfo" style="margin-bottom:40rpx;">
                ...
                <view class="info">
                    <view class="username" style="background-color: var(--publicMainColor);width:100%;margin-bottom: 10px;padding:10rpx"
        ...
        <view class="list">
            ...
            <view @tap="onPageTap('../changepassword/changepassword')" :style='{"padding":"0","boxShadow":"0px 6rpx 12rpx rgba(0, 0, 0, 0.16)","margin":"16rpx 0","backgroundColor":"#fff","borderColor":"var(--publicMainColor)","borderRadius":"0","borderWidth":"0 0 0 22rpx","width":"100%","borderStyle":"solid","height":"80rpx"}' class="li" hover-class="hover">
                <view v-if="true" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0 16rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"var(--publicSubColor)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"30rpx","lineHeight":"30rpx","fontSize":"46rpx","borderStyle":"solid"}' class="cuIcon-moneybag"></view>
            ...
            <block v-for="item in menuList" v-bind:key="item.roleName">
                <block v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <block v-for=" (child,sort) in menu.child">
                        <view :style='{"padding":"0","boxShadow":"0px 6rpx 12rpx rgba(0, 0, 0, 0.16)","margin":"16rpx 0","backgroundColor":"#fff","borderColor":"var(--publicMainColor)","borderRadius":"0","borderWidth":"0 0 0 22rpx","width":"100%","borderStyle":"solid","height":"80rpx"}'
                              @tap="onPageTap('../'+child.tableName+'/list?userId='+user.id)" class="li" hover-class="hover">
                            <view :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0 16rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"var(--publicSubColor)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"30rpx","lineHeight":"30rpx","fontSize":"46rpx","borderStyle":"solid"}' :class="child.appFrontIcon"></view>
            ...
            <view @tap="onPageTap('../forum/forum-my')" :style='{"padding":"0","boxShadow":"0px 6rpx 12rpx rgba(0, 0, 0, 0.16)","margin":"16rpx 0","backgroundColor":"#fff","borderColor":"var(--publicMainColor)","borderRadius":"0","borderWidth":"0 0 0 22rpx","width":"100%","borderStyle":"solid","height":"80rpx"}' class="li" hover-class="hover">
                <view v-if="true" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0 16rpx","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"var(--publicSubColor)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"30rpx","lineHeight":"30rpx","fontSize":"46rpx","borderStyle":"solid"}' class="cuIcon-moneybag"></view>
