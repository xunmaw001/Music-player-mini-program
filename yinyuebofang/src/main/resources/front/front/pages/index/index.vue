...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
      :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"72rpx","borderWidth":"6rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid"}'>
    <view class="left" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1)'}">
    公告信息展示
    </view>
    <view class="right-content" @tap="onPageTap('gonggao')"
          :style="{fontSize:'32rpx',color:'rgba(0, 0, 0, 1)'}">
        查看更多
    </view>
</view><view class="news-box5"
      :style='{"padding":"20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0 10rpx 20rpx","borderColor":"red","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
      style="display: flex;flex-wrap: wrap;">
    <view @tap="onDetailTap('gonggao',item.id)" v-for="(item,index) in gonggaoList" :key="index" class="list-item"
          :style='{"padding":"12rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"6rpx 6rpx","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"4rpx","width":"48%","borderStyle":"solid","height":"auto"}'
          style="display: flex;flex-wrap: wrap;">
        <view
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{item.gonggaoName}}</view>
        <view
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"#999","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}'
                class="category hide2" v-html="item.gonggaoContent">
        </view>
        <view
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"#999","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"24rpx","borderStyle":"solid"}'
                class="time hide1">{{item.insertTime.split(" ")[0]}}</view>
    </view>
</view>
        </view>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
    ...
    <view class="right-content" @tap="onPageTap('yinyue')"
          :style="{fontSize:'32rpx',color:'rgba(0, 0, 0, 1)'}">
        查看更多
    </view>
</view>
<view class="list-box4"
    ...
    <block v-for="(product,index) in yinyueList" :key="index">
        <view v-if="index%6==0" @tap="onDetailTap('yinyue',product.id)" class="list-item"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 8rpx 0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"200rpx 200rpx 20rpx 200rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.yinyuePhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
                        ...
                        class="title hide1">{{product.yinyueName}}
                </view>
            </view>
        </view>
        <view v-if="index%6==1" @tap="onDetailTap('yinyue',product.id)"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"20rpx 100rpx 100rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.yinyuePhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
        ...
        <view v-if="index%6==2" @tap="onDetailTap('yinyue',product.id)"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 20rpx 100rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.yinyuePhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
        ...
        <view v-if="index%6==3" @tap="onDetailTap('yinyue',product.id)" class="list-item"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"var(--publicSubColor)","backgroundColor":"var(--publicSubColor)","borderRadius":"0 0 30rpx 30rpx","borderWidth":"6rpx","width":"100%","borderStyle":"solid","height":"auto"}'>
            <image
        ...
        <view v-if="index%6==4" @tap="onDetailTap('yinyue',product.id)"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 100rpx 100rpx 20rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.yinyuePhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
        ...
        <view v-if="index%6==5" @tap="onDetailTap('yinyue',product.id)"
            ...
            <image
                    :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"100rpx 100rpx 20rpx 100rpx","borderWidth":"10rpx","width":"100%","borderStyle":"solid","height":"200rpx"}'
                    mode="aspectFill" :src="baseUrl+product.yinyuePhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let yinyue = await this.$api.requestCondition('yinyue','gexingtuijian',yinyueVal);

            this.yinyueList = yinyue.data.list
            this.yinyueList.forEach(function(item, index) {
