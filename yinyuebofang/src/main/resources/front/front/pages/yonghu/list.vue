<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <view v-if="isAuth('yonghu','新增')" @click="onAddTap()"
            ...
            <view v-if="isAuth('yonghu','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
	...
	<view style="">
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                ...
                <!-- 级联表 -->
                <!-- 当前表 -->
                 <view v-show="item.yonghuUuidNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">用户编号</text>
                     <text style="width: 70%">
                         <text v-if="item.yonghuUuidNumber != null">{{item.yonghuUuidNumber}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 <view v-show="item.yonghuPhone" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">
                         <text v-if="item.yonghuPhone != null">{{item.yonghuPhone}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 <view v-show="item.yonghuIdNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">
                         <text v-if="item.yonghuIdNumber != null">{{item.yonghuIdNumber}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 ...
                 <view v-show="item.yonghuEmail" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">
                         <text v-if="item.yonghuEmail != null">{{item.yonghuEmail}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 <view v-show="item.jinyongValue" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">账户状态</text>
                     <text style="width: 70%">{{item.jinyongValue}}</text>
                 </view>
		...
		methods: {
			...
			async search() {
				...
				if (this.searchForm.yonghuUuidNumber) {
                    searchForm['yonghuUuidNumber'] = this.searchForm.yonghuUuidNumber
                }
