        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.newsName" type="text" v-model="ruleForm.newsName" placeholder="资讯名称"></input>
            </view>
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.newsPhoto" :src="baseUrl+ruleForm.newsPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.newsContent" v-model="ruleForm.newsContent" placeholder="资讯详情"/>
            </view>
        ...
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.newsName)) {
                    this.$utils.msg(`资讯名称不能为空`);
                    return
                }
				if ((!this.ruleForm.newsPhoto)) {
                    this.$utils.msg(`资讯图片不能为空`);
                    return
                }
                if (this.ruleForm.id) {
