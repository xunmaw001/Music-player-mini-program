			...
			<view class="yinyuewai">
				<view class="yinyuenei"><!-- @tap="onErweima()" -->
						...
						<view class="shangpinfei">
							{{detail.yinyueName}}<!-- <uni-icons type="scan" size="30"></uni-icons> -->
						</view>
				...
				<view class="yinyuewai">
					<view class="yinyuenei">
						...
						<view class="" style="margin: 25rpx;">
							<!-- 封面 poster 歌名 name 作者 author 歌曲 src 可添加（ author="作者字段" ）-->
							<audio :src="baseUrl+detail.yinyueMusic" :poster="detail.yinyuePhoto"
								   :name="detail.yinyueName" :action="{'method':'pause'}" controls></audio>
						</view>
					</view>
				</view>
				<!-- 简介 -->
				<view class="yinyuewai">
					...
					margin-bottom: 25rpx;
					text-indent:24px">
							<rich-text :nodes="detail.yinyueContent"></rich-text>
						</view>
					</view>
				</view>
            <!-- 留言 -->
