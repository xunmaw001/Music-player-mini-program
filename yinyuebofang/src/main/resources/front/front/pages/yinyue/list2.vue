	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('yinyue','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = yinyueTypes.data.list
				...
				let params = {
                    ...
                    yonghuId:this.userId,//查询自己的
							...
							if (this.categoryName != 0) {
                                params.yinyueTypes = this.categoryName
                            }
