    ...
    */
    ...
    public R save(@RequestBody NewsEntity news, HttpServletRequest request){
        ...
        if(newsEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",news.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(news.getNewsContent()) || "null".equals(news.getNewsContent())){
            ...
            List<String> strings = caozuorizhiService.clazzDiff(news, oldNewsEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldNewsList.toString());
        return R.ok();
    }
...
//                            newsEntity.setNewsName(data.get(0));                    //资讯名称 要改的
...
//                            newsEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",newsList.toString());
                        return R.ok();
                    }
                }
            }
...
//            .notIn("news_types", new Integer[]{102})
        ...
        newsService.insert(news);
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"前台新增",news.toString());
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
