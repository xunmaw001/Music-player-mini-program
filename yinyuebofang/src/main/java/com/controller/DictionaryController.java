    ...
    */
    ...
    public R save(@RequestBody DictionaryEntity dictionary, HttpServletRequest request){
        ...
        if(dictionaryEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",dictionary.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
            ...
            servletContext.setAttribute("dictionaryMap",map);
            List<String> strings = caozuorizhiService.clazzDiff(dictionary, oldDictionaryEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldDictionaryList.toString());
        return R.ok();
    }
...
//                            dictionaryEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",dictionaryList.toString());
                        return R.ok();
                    }
                }
            }
